...
<?php }else{?>
	...
	<br>
	<center>
<div class="panel-body"> <font size="10" color="#000267" face="Roboto Condensed" style=" font-weight: bold;"><br><br>No hay boletos agregados</font></div>
<br>
<a href="index.php">
			<button type="button" class="btn btn-primary"><font size="5" color="" face="">Regresar</font></button><br><br><br><br><br><br><br>
</a>
    </center>			
<?php }?>

<script type="text/javascript" src="libs/ajax.js"></script>
	<a><img style="width: 1920px; height: 479px;" src="imagenes/banner.png"></a> 